...
//В футбольной команде 20 человек. Игроки основного состава имеют четные номера,
// а запасные игроки - нечетные. В структуре данных храниться количество очков
// каждого игрока за игру, а игр было 3 Написать метод, который найдет насколько
// больше очков заработал основной состав по отношению к запасным игрокам за каждую
// игру. Определить лучшего игрока за каждую игру и за все игры
